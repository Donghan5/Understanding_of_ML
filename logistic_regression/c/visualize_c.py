...
fig.suptitle('C Logistic Regression Analysis', fontsize=16)
...
axes[1].plot(boundary_df['x_boundary'], boundary_df['y_boundary'], color='crimson', linewidth=3, label='Learned Sigmoid Curve')

axes[1].set_title('Regression Fit on Data', fontsize=14)
axes[1].set_xlabel('X (Feature)')
axes[1].set_ylabel('y (Target / Probability)')
axes[1].legend()

plt.tight_layout(rect=[0, 0, 1, 0.96])
plt.savefig("c_results_plot.png", dpi=150)
plt.show()
print("Final plot saved to c_results_plot.png")